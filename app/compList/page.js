        ...
        <>
            ...
            <div className='m-2 md:mt-20 md:pl-28 pl-4'>
                <div className="container mx-auto -mt-10">
                    <h2 className="text-xl md:text-2xl font-bold text-center align-middle mb-3 text-orange-700" style={{ marginTop: "120px" }} >List of Companies</h2>
                    <div className="mb-4 flex justify-center">
                        <input
                            type="text"
                            placeholder="Search by company name"
                            className="w-full md:w-1/3 border border-gray-700 dark:border-gray-600 focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500 rounded-full px-2 py-1 text-center mt-5"
                            value={searchQuery}
                    ...
                    <div className="flex justify-center items-center h-2/3 md:mb-56"> {/* Adjust spacing */}
                        <table className="table-auto w-full md:w-5/6 ml-44 md:ml-0 mr-16"> {/* Full width on mobile */}
                            <thead className='bg-orange-700 text-white'>
                                <tr>
                                    <th className="px-2 py-2 text-center w-72 ">Sr.No.</th> {/* Add sr.no column */}
                                    <th className="px-2 py-2 text-center w-72">Company Name</th>
                                    <th className="px-2 py-2 text-center w-72">Actions</th>
                                </tr>
                            </thead>
                            <tbody>
                                {companies.length > 0 ? (
